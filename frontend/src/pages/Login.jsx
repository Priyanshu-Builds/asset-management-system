        ...
        <div className="glass-strong" style={{ padding: 36 }}>
          <div style={{ textAlign: 'center', marginBottom: 32 }}>
            <Link to="/" style={{ textDecoration: 'none' }}>
              <div style={{
                ...
                boxShadow: '0 8px 24px rgba(139,92,246,0.3)', cursor: 'pointer',
                transition: 'transform 0.2s, box-shadow 0.2s',
              }}
              onMouseEnter={e => { e.currentTarget.style.transform = 'scale(1.08)'; e.currentTarget.style.boxShadow = '0 10px 28px rgba(139,92,246,0.4)'; }}
            ...
            <p style={{ fontSize: 13, color: '#6b6b8a', marginTop: 6 }}>Sign in to Vaultix Management Suite</p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input type="email" value={email} onChange={e => setEmail(e.target.value)} className="input" style={{ paddingLeft: 38 }} placeholder="admin@volkswagen.in" required />
              </div>
            </div>
            <div>
          ...
          <div style={{ marginTop: 16, paddingTop: 16, borderTop: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8 }}>
              {[
                { l: 'Admin', e: 'admin@volkswagen.in', p: 'admin123' },
                { l: 'IT Mgr', e: 'rahul@volkswagen.in', p: 'password123' },
                { l: 'Employee', e: 'priyanshu@volkswagen.in', p: 'password123' },
              ].map(c => (
